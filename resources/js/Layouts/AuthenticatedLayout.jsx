...
//                                                         {user.roles?.length > 0 && (
//                                                             <span
//                                                                 className="text-xs px-2 py-0.5 rounded-md bg-indigo-100 text-indigo-700 font-semibold w-fit mt-0.5"
//                                                             >
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <nav className="border-b border-gray-100 bg-white">
                                        ...
                                        <span className="inline-flex rounded-md">
                                            ...
                                            >
                                                <span className="flex flex-col text-left leading-tight">
                                                    ...
                                                    {user.roles?.length > 0 && (
                                                        <span className="text-xs px-2 py-0.5 rounded-md bg-indigo-100 text-indigo-700 font-semibold w-fit mt-0.5">
                ...
                {/* Mobile dropdown (you can later add sidebar items here too if you want) */}
                <div
                    className={
                        (showingNavigationDropdown ? 'block' : 'hidden') +
                        ' sm:hidden'
